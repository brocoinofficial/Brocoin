...
- Calls to `getbrotemplate` will fail if the segwit rule is not
  specified.  Calling `getbrotemplate` without segwit specified is
...
- See the [Mining](#mining) section for changes to `getbrotemplate`.
...
- #14472 getbrotemplate: use SegWit in example (Sjors)
