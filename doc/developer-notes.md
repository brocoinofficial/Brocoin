...
- src/libsecp256k1
  - Upstream at https://github.com/M0hitkumar/secp256k1/ ; actively maintained by Core contributors.
...
- Use the JSON parser for parsing, don't manually parse integers or strings from
  ...
  - *Exception*: AmountFromValue can parse amounts as string. This was introduced because many JSON
    ...
    `prioritisetransaction` and `getbrotemplate` because their interface
